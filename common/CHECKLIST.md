...
Use this checklist before finalizing drafted, rewritten, reviewed, explained, or generated work.
Also apply matching task checklists.

* The requested outcome or main point appears near the top.
* Meaning, facts, intent, constraints, audience, and technical claims are preserved.
* Facts, inferences, recommendations, evidence limits, and uncertainty are distinct.
* Claims, certainty, and evidence align.
...
* The output ends with the next useful action, decision point, or validation result when one exists.
